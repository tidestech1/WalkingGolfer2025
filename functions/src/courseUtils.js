...
exports.buildFilterSortConstraints = void 0;
 ...
 */
function buildFilterSortConstraints(filters) {
    var _a;
    logger.debug("[Admin buildFilterSortConstraints LOG] Input Filters:", filters);
    var constraints = [];
    var firstOrderByField = null;
    var sortDirection = filters.sortOrder || "desc";
    ...
    if ((_a = filters.searchQuery) === null || _a === void 0 ? void 0 : _a.trim()) {
        var searchTerm = filters.searchQuery.trim().toLowerCase();
        constraints.push({
    ...
    var finalSortField = filters.sortBy || firstOrderByField || "walkabilityRating_overall";
    var primarySortDirection = (finalSortField === "courseName" && !filters.sortBy) ?
        "asc" :
        sortDirection;
    ...
    logger.debug("[Admin buildFilterSortConstraints LOG] Generated Constraints:", constraints);
    return constraints;
}
exports.buildFilterSortConstraints = buildFilterSortConstraints;
